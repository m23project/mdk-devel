...
\textbf{Returns:}
\begin{itemize}
\item The input value if it contains only characters or stops the program on an error.
\end{itemize}
...
\textbf{Returns:}
\begin{itemize}
\item The input value if it contains only characters and digits or stops the program on an error.
\end{itemize}
...
\subsection{checkIP}
\textbf{Description:} checks if an ip is valid, returns 1 if it is a valid ip otherwise 0\\
\textbf{Parameter:}
\begin{itemize}
...
\textbf{Description:} checks if a netmask is valid, returns 1 if it is a valid netmask otherwise 0\\
\textbf{Parameter:}
\begin{itemize}
...
\textbf{Description:} Touches a log file in the client's directorya and returns the full name of the log file (with directory).\\
\textbf{Parameter:}
\begin{itemize}
\item client: Name of the client.
...
\textbf{Parameter:}
\begin{itemize}
\item in: Input v4 IP (e.g. 192.168.1.23)
\end{itemize}
\textbf{Returns:}
\begin{itemize}
\item Unsigned long representation of the input IP.
\end{itemize}
...
\item bootType: Parameter can a string: pxe, etherboot, gpxe
\end{itemize}
...
\subsection{FDISK\_showFdiskGUIDialogEnd}
\textbf{Description:} Shows the block at the end of the partitioning and formating dialog with partition and file system information about the currently selected drive and buttons for resetting and refreshing the dialog.\\
...
\subsection{FDISK\_showFdiskGUIDriveInfoDialog}
\textbf{Description:} Shows a block with partitioning and file system information for the currently choosen installation drive. It contains dialog for changing the installation drive.\\

\subsection{FDISK\_showFdiskGUIlistPartJobs}
\textbf{Description:} Shows a list of all waiting partitioning and fromating jobs.\\
...
\subsection{FDISK\_showFdiskGUISelectPartitionMethod}
\textbf{Description:} Shows a dialog for choosing the partitioning method and storing the method.\\

\subsection{FDISK\_showFdiskGUIDialog}
\textbf{Description:} Shows the whole partition and formating dialog.\\

\subsection{FDISK\_showFdiskGUITitle}
\textbf{Description:} Returns and/or shows the current title of the partitioning and formating.\\
\textbf{Parameter:}
\begin{itemize}
\item show: Shows the title if set to true and returns it if set to false.
\end{itemize}
\textbf{Returns:}
\begin{itemize}
\item The current title of the partitioning and formating.
\end{itemize}

\subsection{FDISK\_showFdiskGUIAutoMethod}
\textbf{Description:} Shows the dialog for automatic partitioning and formating.\\

\subsection{FDISK\_showFdiskGUIExistingMethod}
\textbf{Description:} Shows the dialog for formating of existing partitions.\\

\subsection{FDISK\_fdiskSessionExtendedPartStep}
\textbf{Description:} Stores the extended partitioning step and sets the help page and title in the session.\\
\textbf{Parameter:}
\begin{itemize}
\item newStep: The new step to set or false for not changing.
\end{itemize}
\textbf{Returns:}
\begin{itemize}
\item The current extended partitioning step.
\end{itemize}

\subsection{FDISK\_showFdiskGUIExtendedStepDeletePartitions}
\textbf{Description:} Shows the sub-dialog for deleting partitions in the extended partitioning and formating dialog.\\

\subsection{FDISK\_showFdiskGUIExtendedStepAddNewPartition}
\textbf{Description:} Shows a dialog for adding partitions.\\

\subsection{FDISK\_showFdiskGUIExtendedStepFormatPartitions}
\textbf{Description:} Shows a dialog for formating partitions.\\

\subsection{FDISK\_showFdiskGUIExtendedMethod}
\textbf{Description:} Shows the dialog for extended partitioning and formating.\\
...
\subsection{FDISK\_getAfterLastPartition}
\textbf{Description:} gets the amount of free space after the last partition in ???\\
\textbf{Parameter:}
\begin{itemize}
\item param: parameter string containing status informations about the harddisks
\item vDev: Virtual (internally used) device number.
...
\item tabelType: Name of the CSS table type
\item width: Width of the box
\item storeFile: The file name to store the download in.
\item refreshTime: The time in minutes the file is downloaded again.
\end{itemize}
...
\subsection{PKG\_addNormaltoPackageselection}
\textbf{Description:} add normal packages to selection\\
\textbf{Parameter:}
\begin{itemize}
\item client: name of client to install packages on
\item selectionName: name for the package selection
