...
\textbf{Description:} Checks if the input value is a valid device name for a HD drive or partition.\\
\textbf{Parameter:}
\begin{itemize}
...
\textbf{Returns:}
\begin{itemize}
\item The input value is a a valid drive or partition or false on an error.
\end{itemize}
