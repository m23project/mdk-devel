\newcommand{\bildrechts}[1]{ %#1: Bild, das nach rechts flieﬂen soll
...
\newcommand{\kommando}[1]{ %#1: code
	\fboxsep0.6mm
	\colorbox{Gray}{\fbox{\textbf{\tt{#1} \keys{\return}}}}
}
...
\newcommand{\includeDIFF}[1]{ %#1: codefile
	\ \\
	\\
	\inputminted[linenos, numbersep=5pt, frame=lines, framesep=2mm, bgcolor=Gray, fontseries=sffamily, funcnamehighlighting=true, obeytabs=true, fontsize=\footnotesize]{diff}{#1}
	\smallskip
}
...
\newcommand{\includeBASH}[1]{ %#1: codefile
	\ \\
	\\
	\inputminted[linenos, numbersep=5pt, frame=lines, framesep=2mm, bgcolor=Gray, fontseries=sffamily, funcnamehighlighting=true, obeytabs=true, fontsize=\footnotesize]{bash}{#1}
	\smallskip
}
...
\newcommand{\includeHTML}[1]{ %#1: codefile
	\ \\
	\\
	\inputminted[linenos, numbersep=5pt, frame=lines, framesep=2mm, bgcolor=Gray, fontseries=sffamily, funcnamehighlighting=true, obeytabs=true, fontsize=\footnotesize]{html}{#1}
	\smallskip
}
...
\newcommand{\includePHP}[1]{ %#1: codefile
	\ \\
	\\
	\inputminted[linenos, numbersep=5pt, frame=lines, framesep=2mm, bgcolor=Gray, fontseries=sffamily, funcnamehighlighting=true, obeytabs=true, fontsize=\footnotesize]{php}{#1}
	\caption{#1}\\
	\smallskip
}
